CFLAGS=-pipe -O2 -march=armv8-a+crc -mtune=cortex-a72 -ftree-vectorize -funsafe-math-optimizations -fomit-frame-pointer -Wno-psabi -g
...
INCLUDES+=-I./ -Ilinux -Iffmpeg_compiled/usr/local/include/ -I/usr/include/dbus-1.0 -I /usr/lib/aarch64-linux-gnu/dbus-1.0/include  -I/usr/include/freetype2 -isystem$(SDKSTAGE)/opt/vc/include -isystem$(SDKSTAGE)/opt/vc/include/interface/vcos/pthreads
